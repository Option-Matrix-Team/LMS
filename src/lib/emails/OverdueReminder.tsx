...
export default function OverdueReminderEmail({
    ...
    return (
        <Html>
            <Head />
            <Preview>OVERDUE: {bookTitle} - {String(daysOverdue)} days overdue</Preview>
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Section style={overdueSection}>
                        ...
                        <Text style={overdueValue}>{daysOverdue} {daysOverdue === 1 ? 'day' : 'days'}</Text>
                        <Text style={originalDue}>Originally due: {dueDate}</Text>
                    </Section>
                    
                    <Text style={urgentText}>
                        Please return this book as soon as possible. Continued overdue status may 
                        affect your ability to borrow books in the future.
                    </Text>
