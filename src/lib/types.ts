...
export type BorrowingPolicy =
  Database["public"]["Tables"]["borrowing_policies"]["Row"];
...
export type BorrowingInsert =
  Database["public"]["Tables"]["borrowings"]["Insert"];
export type BorrowingPolicyInsert =
  Database["public"]["Tables"]["borrowing_policies"]["Insert"];
...
export type BorrowingUpdate =
  Database["public"]["Tables"]["borrowings"]["Update"];
export type BorrowingPolicyUpdate =
  Database["public"]["Tables"]["borrowing_policies"]["Update"];
