...
export function AppSidebar({ userRole, userName, libraryName }: AppSidebarProps) {
        ...
        <aside className="flex flex-col h-screen w-64 bg-sidebar border-r border-sidebar-border">
            ...
            {libraryName && (
                <div className="px-4 py-3 bg-sidebar-accent/50 border-b border-sidebar-border">
                    ...
                    <p className="text-sm font-medium text-sidebar-foreground truncate">{libraryName}</p>
                </div>
            )}
