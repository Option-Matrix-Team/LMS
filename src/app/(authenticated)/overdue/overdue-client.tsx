...
import { returnBook, extendBorrowing } from '@/lib/actions/borrowings';
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Members with books past their due date</p>
            </div>
            ...
            {borrowings.length === 0 ? (
                <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground">All borrowed books are within their due dates</p>
                </div>
            ) : (
                <>
                    <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-4">
                        <div className="flex items-center gap-2 text-destructive">
                            ...
                            <span className="font-medium">{borrowings.length} overdue book(s)</span>
                        </div>
                    </div>
                                ...
                                <TableRow key={borrowing.id}>
                                    ...
                                    <TableCell>
                                        <div className="text-sm">
                                            ...
                                            <div className="text-muted-foreground">{borrowing.members?.email}</div>
                                        </div>
                                    </TableCell>
