...
import { Settings, BookOpen, Clock, RefreshCw, Loader2 } from 'lucide-react';
...
export function PoliciesClient({ initialPolicy, isAdmin }: PoliciesClientProps) {
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    ...
                    <Card>
                        <CardHeader className="pb-3">
                            ...
                            <CardDescription>
                                How long members can keep books
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-2">
            ...
            <Card className="bg-muted/50">
                ...
                <CardContent>
                    <ul className="space-y-2 text-sm">
                        <li>
                            • Members can borrow up to <strong>{policy.max_books_per_member} books</strong> at a time
                        </li>
                        <li>
                            • Books are due after <strong>{policy.borrow_duration_days} days</strong>
                        </li>
                        <li>
                            • {policy.extension_duration_days > 0 ? (
                                <>Members can extend once for <strong>{policy.extension_duration_days} extra days</strong></>
                            ) : (
