...
import { Plus, Trash2, Building2, Copy } from 'lucide-react';
...
export function LibrariesClient({ initialLibraries }: LibrariesClientProps) {
    ...
    const handleDeleteLibrary = async (id: string) => {
        if (!confirm('Are you sure you want to delete this library? This will also delete all books, members, and borrowings associated with it.')) return;
        ...
        <div className="space-y-6">
                    ...
                    <DialogContent className="sm:max-w-[500px]">
                        <form onSubmit={handleAddLibrary}>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Create a new library organization. You can assign admins after creation.
                                </DialogDescription>
                            </DialogHeader>
                            <div className="grid gap-4 py-4">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input id="address" name="address" placeholder="e.g., 123 Main Street" />
                                </div>
                            </div>
                            <DialogFooter>
            ...
            {libraries.length === 0 ? (
                <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground">Create your first library to get started</p>
                </div>
            ) : (
                <Table>
                    <TableHeader>
                    ...
                    <TableBody>
                        {libraries.map((library) => (
                            <TableRow key={library.id}>
                                ...
                                <TableCell>{format(new Date(library.created_at), 'MMM d, yyyy')}</TableCell>
                                <TableCell>
                                    <Button
                                        variant="ghost"
                                        size="icon-sm"
